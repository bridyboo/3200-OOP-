...
* 
* FOR MI 
* made new changes for allowing smoother transition for  MI
* a lot of function specific to derived classes has been added with no implementation in 
* base class. Sacrificed abstraction and simplicity for MI capability
*/
...
public class Robot : IRobot
{
    ...
    //pre: none
    //post : grid will change 
    public void changeGrid(string file)
    {
        if (file == null) throw new ArgumentNullException("invalid file");
    ...
    //pre: none
    //post: breaks encapsulation but for MI sacrifice 
 ...
 * 
 * changeGrid() breaks abstraction + encapsulation
 * rotate(), Down(), Left(),Right() breaks abstraction 
 * 
 */
